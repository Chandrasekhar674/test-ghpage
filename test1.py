...
g = Github("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") # Your personal token
...
def change_protected_branch_settings_test():
    repo = g.get_repo("Chandrasekhar674/test-ghpage")
    branch = g.get_repo("Chandrasekhar674/test-ghpage").get_branch("main")
    branch.edit_protection(required_approving_review_count=2, enforce_admins=True)
